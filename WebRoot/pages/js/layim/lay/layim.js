...
//渲染骨架
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main" style="height:100%;">'
            +'<div class="xxim_top" id="xxim_top" style="height:90%">'
            ...
            +'  <ul class="xxim_list" style="display:block;height:100%"></ul>'
