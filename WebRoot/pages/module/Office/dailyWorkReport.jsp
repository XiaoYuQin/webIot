	...
	<div class="easyui-panel" style="width: 100%;height: 100%">
		<div class="easyui-tabs1" style="width:100%;height:100%">
			<div title="发日志" data-options="closable:false" class="basic-info">		
				<div class="easyui-panel" style="width: 100%;height: 97%;margin-top: 1%;">
					<div style="font-size: 25px;text-align: center;">区域主任每日工作日报</div>
				   	<span class="info">汇报人：</span>
					...
					<div class="easyui-panel" style="width: 100%;height: 400px;margin-top: 10px;">
<!-- 						<div class="demo-info" style="margin-bottom:10px">
	...
	<!-- 			<div class="easyui-panel" title="1" style="margin-top: 20px; margin-left:10%;width: 50%;height: 100%" 
					data-options="style:{borderWidth:5}"></div>		 -->	
				<!-- <iframe src="<%=basePath%>/pages/module/Office/dailyWorkReportSent.jsp" style="width:50%;height:80%;margin-top: 2%;margin-left: 24%"></iframe>			 -->
				<!-- <div class="easyui-panel" style="width:50%;height:80%;margin-top: 5%;margin-left: 5%"
			    		data-options="style:{borderWidth:2}">
			    </div> -->
<!-- 				<div class="easyui-panel" title="" style="width: 100%;height: 100%;">					 
				   	<div style="text-align: center;font-size: 25px">区域主任每日工作日报</div>
				   	<span class="info">汇报人：</span>
				   	<span class="info">焦润连</span>
				   	<span class="info">&#12288;&#12288;</span>
				   	<span class="info">汇报时间：</span>
			    ...
			    <thead>  
			        <tr>  
			            <th colspan="6"><font size="3">区域主任每日工作日报</font></th>             
			        </tr> 
			        <tr>
			        	<th rowspan="1" field="date1" width="16%" align="center">汇报人：</th>  
			        	<th rowspan="1" field="date2" width="16%" align="center">焦润连</th>  
						<th rowspan="1" field="date3" width="16%" align="center">汇报时间：</th>  
			        	<th rowspan="1" field="date4" width="16%" align="center">2016/11/20</th>  
						<th rowspan="1" field="date5" width="16%" align="center">区域</th>  
			        	<th rowspan="1" field="date6" width="16%" align="center">华北</th>  			        	
			        </tr> 
					<tr>  
			            <th colspan="6" field="date" width="100%" align="center">日期</th>       
			        </tr> 
