...
<html>
  <head>
    ...
    <title>My JSP 'im.jsp' starting page</title>
	...
	-->
	<script type="text/javascript" src="<%=basePath%>/pages/js/nim/NIM_Web_SDK_v3.2.0.js"></script>
...
var nim = SDK.NIM.getInstance({
    // 初始化SDK
			// debug: true
			appKey: '7ee0cb8c2d8748a84c7bd6fd96784139',
			account: 'aaa',
			token: 'aaaaaa',
			onconnect: onConnect,
			onerror: onError,
	...
	function onUsers(users) {
			...
			{
				console.log('users.account', users[i].account);
				console.log('users.nick', users[i].nick);
				console.log('users.avatar', users[i].avatar);
			}
