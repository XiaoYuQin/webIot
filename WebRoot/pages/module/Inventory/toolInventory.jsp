...
<body style="overflow: hidden;">
	...
	<div id="dlg" class="easyui-dialog" title="工具盘点" data-options="closed:true,buttons:'#dlg-buttons'" style="width:1000px;height:500px;padding:10px;">
		<table id="te" style="width:100%;height:100% ;"
			...
			<thead>
				<tr>
			            <th field="t1" width="12%">品名</th>
			            <th field="t2" width="12%">盘点数</th>
			            <th field="t3" width="12%">借出数</th>
			            <th field="t4" width="12%">库房数</th>
			            <th field="t5" width="15%">报废数</th>
			            <th field="t6" width="15%">用途</th>
			            <th field="t7" width="18%">备注</th>			
				</tr>
			</thead>
		</table>
	</div>
...
function getData()
{
    ...
    rows.push({
        t1: '北京国能电池科技有限公司',
        t2: '售后材料库',
        t3: '2016年12月份备件库房工具盘点',
        t4: '1000'
    });
    rows.push({
        t1: '北京国能电池科技有限公司',
        t2: '售后材料库',
        t3: '2016年11月份备件库房工具盘点',
        t4: '1000'
    });
    rows.push({
        t1: '北京国能电池科技有限公司',
        t2: '售后材料库',
        t3: '2016年10月份备件库房工具盘点',
        t4: '1000'
    });
    rows.push({
        t1: '北京国能电池科技有限公司',
